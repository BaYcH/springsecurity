package com.bayc.springsecurity.model.response;
...
public class Result implements Serializable {
    ...
    public static Result unAuth(Object msg) {
        return new Result(ResultCode.UNAUTHORIZED.getCode(), ResultCode.UNAUTHORIZED.getMessage(), msg);
    }
    ...
    public static Result forbidden(Object msg) {
        return new Result(ResultCode.FORBIDDEN.getCode(), ResultCode.FORBIDDEN.getMessage(), msg);
    }
